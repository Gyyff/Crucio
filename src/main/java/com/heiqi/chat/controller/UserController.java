...
public class UserController {
  ...
  public UserController(
      UserService userService, UserPreferenceService userPreferenceService, MatchUtils matchUtils) {
  ...
  public Result sendMessageToUserOther(
      @PathVariable("UserId") int UserId, @RequestBody String messages) throws Exception {
  ...
  public Result uploadUserPhoto(
      @PathVariable("UserId") int UserId, @RequestBody MultipartFile file, BaseUser baseUser)
      throws IOException {
  ...
  public Result updateUserWeChat(
      @PathVariable("UserId") int UserId, @RequestBody String WeChat, BaseUser baseUser) {
  ...
  public Result updateUserMatchChoiceAuto(@PathVariable("UserId") int UserId, BaseUser baseUser) {
    ...
    if (userPreferenceService.getUserPreferenceFoundationByUserId(UserId) == null
        && userById.getIsPreference() == 0
        && userById.getIsTested() == 0) {
  ...
  public void updateUserName(
      @PathVariable("UserId") int UserId, @RequestBody String UserName, BaseUser baseUser) {
    userService.updateUserName(UserId, UserName);
  }

  @PutMapping("/updateUserAge/{UserId}")
  public void updateUserAge(
      @PathVariable("UserId") int UserId, @RequestBody int Age, BaseUser baseUser) {
    userService.updateUserAge(UserId, Age);
  }

  @PutMapping("/updateUserIdentity/{UserId}")
  public void updateUserIdentity(
      @PathVariable("UserId") int UserId, @RequestBody String Identity, BaseUser baseUser) {
    userService.updateUserIdentity(UserId, Identity);
  }

  @PutMapping("/updateUserEducation/{UserId}")
  public void updateUserEducation(
      @PathVariable("UserId") int UserId, @RequestBody int Education, BaseUser baseUser) {
  ...
  public void updateUserPhoto(
      @PathVariable("UserId") int UserId, @RequestBody String Photo, BaseUser baseUser) {
    userService.updateUserPhoto(UserId, Photo);
  }

  @PutMapping("/updateUserIsAuthed/{UserId}")
  public void updateUserIsAuthed(
      @PathVariable("UserId") int UserId, @RequestBody int IsAuthed, BaseUser baseUser) {
    userService.updateUserIsAuthed(UserId, IsAuthed);
  }

  @PutMapping("/updateUserIsLogged/{UserId}")
  public void updateUserIsLogged(
      @PathVariable("UserId") int UserId, @RequestBody int IsLogged, BaseUser baseUser) {
    userService.updateUserIsLogged(UserId, IsLogged);
  }

  @PutMapping("/updateUserIsTested/{UserId}")
  public void updateUserIsTested(
      @PathVariable("UserId") int UserId, @RequestBody int IsTested, BaseUser baseUser) {
  ...
  public Result bindDevice(@RequestBody UserDevice userDevice) {
    return userService.bindDevice(
        userDevice.getUserId(), userDevice.getDeviceId(), userDevice.getClientType());
  }
}
